...
/**
 * Load and render access requests
 */
    ...
    try {
        ...
        listEl.innerHTML = filtered.map(req => {
            ...
            <div class="ar-card" data-id="${req.docId}" data-status="${req.status}"
                style="background: var(--card-bg); border: 1px solid var(--border-color); border-radius: 16px; padding: 20px; margin-bottom: 16px; transition: transform 0.2s, box-shadow: 0.2s; box-shadow: 0 4px 6px rgba(0,0,0,0.05); position: relative; overflow: hidden;">
